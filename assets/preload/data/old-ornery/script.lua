...
function onUpdate(elapsed)
  ...
  function onCreatePost() 
    makeLuaText("message", "offbeat song makes your mom so fat AAAA- | Song by joolian", 500, 30, 50)
    setTextAlignment("message", "left")
    addLuaText("message")

    makeLuaText("engineText", "Ornery (Old) - Definitive Engine (PE v0.6.3)", 500, 30, 30)
