...
function onCreatePost() 
    makeLuaText("message", "Nothin' personal Kid | Song By ThatPizzaTowerFan", 500, 30, 50)
    setTextAlignment("message", "left")
    addLuaText("message")

    makeLuaText("engineText", "Hadephobia/Hellbreaker - Definitive Engine (PE v0.6.3)", 500, 30, 30)
